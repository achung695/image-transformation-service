...
A full-stack Next.js app that removes the background from an uploaded image, flips it horizontally, hosts the result on Cloudinary, and provides a shareable URL. Deployed using Vercel.
